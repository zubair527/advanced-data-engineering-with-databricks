...
# MAGIC 
# MAGIC ## Flagging
# MAGIC To avoid multiple writes and managing multiple tables, you may choose to implement a flagging system to warn about violations while avoiding job failures. These flags can easily be used in downstream queries to isolate bad data.
# MAGIC 
