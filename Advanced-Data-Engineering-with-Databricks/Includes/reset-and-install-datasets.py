...
if mode == "reset":
    ...
    dbutils.fs.rm(f"dbfs:/user/{username}/streaming_logs/", True)
    dbutils.fs.rm(f"dbfs:/user/{username}/streaming_logs_delta/", True)
    dbutils.fs.rm(f"dbfs:/user/{username}/streaming_logs_delta/_checkpoint", True)
